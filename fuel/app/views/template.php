...
<body>
<?php include_once Asset('assets/js/analyticstracking.php') ?>
        ...
        <div class="row">
          <div class="col-md-8 col-md-offset-2 text-center">
            <ul class="list-inline">
              ...
              <li><a href="https://twitter.com/MFCastagnola" target="_blank" class="lnkSocial" data-placement="bottom" title="@MFCastagnola"><i class="fa fa-twitter fa-3x" ></i></a></li>
